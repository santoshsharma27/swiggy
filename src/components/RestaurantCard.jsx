...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="m-4 p-3 w-full max-w-[290px] sm:max-w-[300px] lg:max-w-[320px] rounded-lg bg-gray-100 hover:bg-gray-200 flex flex-col shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105">
      <img
